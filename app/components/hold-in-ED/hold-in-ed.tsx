...
import { HoldInEDStyles as styles } from "./hold-in-ed.styles";
...
export const HoldInED: React.FC<Props> = ({ navigation }) => {
  const actionItems = [
    {
      id: 1,
      label: "Email a Copy",
          ...
          <View style={styles.CARD}>
            ...
            >
              ...
              >
                ...
                >
                  {`buprenorphine 4 mg once their COWS \n     score is an 8 or greater in the ED today`}
                </Text>
              </Text>
            </Text>
            ...
            >
              ...
              >
                {`a prescription for naloxone nasal spray`}
              </Text>
            </Text>
            ...
            >
              ...
              >
                {`educational material on opioid use \n    disorder, naloxone use, this study`}
              </Text>
            </Text>
            ...
            >
              ...
              >
                {`instructions to return to the ED in 24 \n    hours for their next dose of buprenorphine if \n    they are unable to schedule an appointment \n    with a buprenorphine prescriber tomorrow`}
              </Text>
            </Text>
            ...
            >
              ...
              >
                Hold the patient in the ED until withdrawal worsens to a COWS
                score of 8 or more and order Buprenorphine-naloxone tablet 4 mg
                or return to this app for further guidance.
              </Text>
            </Text>
            <Text
              style={{
            ...
            >
              ...
              >
                Naloxone Nasal Spray 4 mg AVS/Discharge
              </Text>
            </Text>
            <Text
              style={{
