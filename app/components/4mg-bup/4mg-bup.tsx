...
import { FourMgBupStyles as styles } from "./4mg-bup.styles";
...
export const FourMgBup: React.FC<Props> = ({ navigation }) => {
  const actionItems = [
    {
      id: 1,
      label: "Email a Copy",
          ...
          <View style={styles.CARD}>
            ...
            >
              ...
              >
                ...
                >
                  {`buprenorphine 4 mg in the ED today, be \n    observed for 45-60 minutes, and given \n    another dose of 4 mg if they have no side \n    effects `}
                </Text>
              </Text>
            </Text>
            ...
            >
              ...
              >
                Buprenorphine-naloxone (SUBOXONE) SL tablet 4 mg. Administer 4
                mg now and observe patient for 45-60 minutes. If no adverse
                events, administer second dose.
              </Text>
            </Text>
            <Text
              style={{
