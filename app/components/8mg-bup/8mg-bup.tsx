...
import { EightMgBupStyles as styles } from "./8mg-bup.styles";
...
export const EightMgBup: React.FC<Props> = ({ navigation }) => {
  const actionItems = [
    {
      id: 1,
      label: "Email a Copy",
          ...
          <View style={styles.CARD}>
            ...
            <View style={styles.CHILD_CARD}>
              ...
              >
                ...
                >
                  ...
                  >
                    {`withdrawal score greater than 12, `}
                  </Text>
            ...
            >
              ...
              >
                ...
                >
                  {`buprenorphine 8 mg in the ED today, be \n    observed for 45 minutes to ensure they have \n    no side effects to medication`}
                </Text>
              </Text>
            </Text>
            ...
            >
              ...
              >
                Buprenorphine-naloxone tablet 8 mg. Administer 8 mg now and
                observe patient for 45 minutes to ensure they have no adverse
                effects.
              </Text>
            </Text>
            <Text
