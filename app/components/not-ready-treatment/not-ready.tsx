...
import { NotReadyStyles as styles } from "./not-ready.styles";
...
export const NotReady: React.FC<Props> = ({ navigation }) => {
  const actionItems = [
    {
      id: 1,
      label: "Email a Copy",
        ...
        <ScrollView bounces={false} contentContainerStyle={styles.CONTAINER}>
          ...
          <View style={styles.CARD}>
            <View style={styles.CARD_HEADER}>
              ...
              >
                Care Pathway 1: Not Ready for BUP
              </Text>
            </View>
            ...
            <View style={styles.CHILD_CARD}>
              ...
              >
                ...
                >
                  {`willing to accept referral for addiction treatment `}
                  <Text
                    style={{
                      ...styles.CARD_TITLE,
                      fontSize: 14,
                  ...
                  >
                    therefore, I have generated a referral for treatment
                  </Text>
                </Text>
              </Text>
            </View>
